...
import "../contracts/IJoeRouter.sol";
import "../contracts/IJoeFactory.sol";
import "../contracts/IJoePair.sol";
import "../contracts/ILiquidityPoolManager.sol";
import "../contracts/OwnerRecovery.sol";
import "../contracts/TempleKinImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    TempleKinImplementationPointer
{
    ...
    constructor(
        ...
        changeTempleKinImplementation(address(leftSide));
